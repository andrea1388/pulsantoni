...
class RFM69 {
  public:
    ...
    bool canSend();
    virtual bool send(uint8_t toAddress, const void* buffer, uint8_t bufferSize, bool requestACK=false);
  ...
  protected:
    ...
    virtual bool sendFrame(uint8_t toAddress, const void* buffer, uint8_t size, bool requestACK=false, bool sendACK=false);
